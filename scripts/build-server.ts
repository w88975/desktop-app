#!/usr/bin/env bun
/**
 * Build script for standalone Huaxiaozhu server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for Huaxiaozhu
...
# Huaxiaozhu Server — convenience entry point
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building Huaxiaozhu Server ${version} for ${platform}-${arch} ===`);
