#!/usr/bin/env bun
/**
 * Debug script to print the full Huaxiaozhu system prompt with annotations.
...
printAnnotation('  2. Huaxiaozhu Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  ...
  systemPrompt.append: getSystemPrompt() ${colors.dim}// Huaxiaozhu additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. Huaxiaozhu Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
