...
This guide explains how to create and configure skills in Huaxiaozhu.
...
Huaxiaozhu uses **the identical SKILL.md format** as the Claude Code SDK. This means:

1. **Format compatibility**: Any skill written for Claude Code works in Huaxiaozhu
