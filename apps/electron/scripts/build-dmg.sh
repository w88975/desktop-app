...
echo "=== Building Huaxiaozhu DMG (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder.yml uses artifactName to output: Huaxiaozhu-${arch}.dmg
DMG_NAME="Huaxiaozhu-${ARCH}.dmg"
