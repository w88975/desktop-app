...
echo "=== Building Huaxiaozhu AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Huaxiaozhu-x86_64.AppImage or Huaxiaozhu-aarch64.AppImage
BUILT_APPIMAGE_NAME="Huaxiaozhu-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Huaxiaozhu-x64.AppImage, Huaxiaozhu-arm64.AppImage
APPIMAGE_NAME="Huaxiaozhu-${ARCH}.AppImage"
