...
function BrowserAgentEmptyState({
  ...
  const handlePromptSelect = useCallback(async (prompt: string) => {
    ...
    const deepLinkUrl = `huaxiaozhu://${deepLinkRoute}`
...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  ...
  'long-names': [
    {
      id: 'long-1',
      url: 'https://www.notion.so/Huaxiaozhu-Multi-Session-Browser-Registry-Design-Review-Thread-2026-Q1',
      title: 'Huaxiaozhu Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
  ...
  'stress-mix': [
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/lukilabs/craft-agents-oss',
      title: 'Huaxiaozhu OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
