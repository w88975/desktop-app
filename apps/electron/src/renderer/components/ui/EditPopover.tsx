  ...
  'add-source-local': (location) => ({
    context: {
      ...
      context:
        ...
        'First, look up the filesystem source guide in the product docs at https://docs-aiadp.hxsyai.com/. ' +
...
export function EditPopover({
  ...
  const handleLegacySendMessage = useCallback((message: string) => {
    ...
    const url = `huaxiaozhu://action/new-session?input=${encodedInput}&send=true&mode=${permissionMode}&badges=${encodedBadges}${workdirParam}${modelParam}${systemPromptParam}`
